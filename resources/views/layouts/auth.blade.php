        ...
        <!-- <body data-layout="horizontal" data-topbar="dark"> -->
                        ...
                        <div class="d-flex">
                            ...
                            <div class="navbar-brand-box">
                                <a href="index.html" class="logo logo-dark">
                                    ...
                                    <span class="logo-lg">
                                        <img src="assets/auth/images/logo-dark.png" alt="logo-dark" height="20">
                                    </span>
                                </a>
                                ...
                                <a href="index.html" class="logo logo-light">
                                    ...
                                    <span class="logo-lg">
                                        <img src="assets/auth/images/logo-light.png" alt="logo-light" height="20">
                                    </span>
                                </a>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-5">
                                                    <div>
                                                        <img src="assets/auth/images/megamenu-img.png" alt="megamenu-img" class="img-fluid mx-auto d-block">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="dropdown d-none d-sm-inline-block">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <img src="assets/auth/images/flags/spain.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">Spanish</span>
                                    </a>

                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <img src="assets/auth/images/flags/germany.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">German</span>
                                    </a>

                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <img src="assets/auth/images/flags/italy.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">Italian</span>
                                    </a>

                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <img src="assets/auth/images/flags/russia.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">Russian</span>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="dropdown d-inline-block">
                                ...
                                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                                    ...
                                    <div data-simplebar style="max-height: 230px;">
                                        ...
                                        <a href="" class="text-reset notification-item">
                                            <div class="d-flex">
                                                <img src="assets/auth/images/users/avatar-3.jpg"
                                        ...
                                        <a href="" class="text-reset notification-item">
                                            <div class="d-flex">
                                                <img src="assets/auth/images/users/avatar-4.jpg"
                                                    class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                <div class="flex-1">
                ...
                <div class="vertical-menu">
                    ...
                    <div data-simplebar class="h-100">
                        ...
                        <div class="user-profile text-center mt-3">
                            <div class="">
                                <img src="assets/auth/images/users/avatar-1.jpg" alt="" class="avatar-md rounded-circle">
                            </div>
                            <div class="mt-3">
            ...
            <div class="right-bar">
                <div data-simplebar class="h-100">
                    ...
                    <div class="p-4">
                        <div class="mb-2">
                            <img src="assets/auth/images/layouts/layout-1.jpg" class="img-fluid img-thumbnail" alt="layout-1">
                        </div>
                        ...
                        <div class="mb-2">
                            <img src="assets/auth/images/layouts/layout-2.jpg" class="img-fluid img-thumbnail" alt="layout-2">
                        </div>
                        <div class="form-check form-switch mb-3">
                        ...
                        <div class="mb-2">
                            <img src="assets/auth/images/layouts/layout-3.jpg" class="img-fluid img-thumbnail" alt="layout-3">
                        </div>
