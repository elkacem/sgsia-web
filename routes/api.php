...
Route::post('/surveys', function (Request $request) {
    $request->validate([
        ...
        'hall_escalier' => 'nullable',
        'hall_escalator' => 'nullable',
        'hall_ascenceur' => 'nullable',
...
//        'passerelle_bus' => 'required_if:status,arrivee',
        ...
        'passerelle_sol' => 'nullable',
        'passerelle_vitre' => 'nullable',
        'passerelle_bus' => 'nullable',
